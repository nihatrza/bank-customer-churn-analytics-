...
Customer retention is a critical driver of profitability in the retail banking sector. This project analyzes a dataset of 10,000 customers across three European markets (France, Germany, Spain) to uncover the hidden drivers of churn. By implementing **Rule-Based Risk Segmentation** using advanced DAX formulations, the solution transitions from descriptive analytics (what happened) to prescriptive insights (who is at risk and why).
...
Extensive SQL querying and Power BI cross-filtering revealed highly actionable insights for the executive board:

- 🚨 **The Complaint Catalyst**: 99.51% of customers who logged a complaint eventually churned (2,034 out of 2,044). In contrast, the churn rate for non-complaining customers was near zero (0.05%). This highlights a critical failure in the customer support resolution pipeline.
- 🌍 **The German Market Anomaly**: The churn rate in Germany is critically high at ~32.44%, regardless of card tier. Furthermore, departing German customers hold an average balance of €120,000, meaning the financial bleed in this region is disproportionately severe.
- 📉 **Age Vulnerability**: The 46–60 age demographic (Senior Professionals) exhibits a massive 51.12% churn rate, identifying them as the most flight-risk segment.
- 💳 **Product Engagement**: Clients utilizing only a single banking product account for 69.14% of the total churned customer base, underlining the need for aggressive cross-selling retention campaigns.
